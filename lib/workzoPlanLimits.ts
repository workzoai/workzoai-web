...
export const WORKZO_PLAN_LIMITS: Record<WorkZoPlanType, WorkZoPlanLimits> = {
  ...
  premium: {
    ...
    description: "Practice every day with 300 AI voice minutes and unlimited career tools for active job applications.",
  ...
  premium_pro: {
    ...
    description: "The full WorkZo system: 600 AI voice minutes, 60 AI video minutes (early access), advanced performance analysis, and multi-session history.",
...
export function getWorkZoPlanUpgradeCopy(feature?: string) {
  ...
  if (normalized.includes("video") || normalized.includes("avatar") || normalized.includes("video") || normalized.includes("coach") || normalized.includes("pro")) {
    return {
      ...
      description:
        "Get the full WorkZo experience with 600 AI voice minutes, AI video practice (early access), advanced performance analysis, and priority models.",
      bullets: [
        "600 AI voice minutes / month",
        "60 AI video minutes / month (early access)",
  ...
  return {
    ...
    description:
      "Get 300 AI voice minutes a month, advanced reports, Career Brain, CV improvement, cover letters, and job preparation tools.",
    bullets: ["300 AI voice minutes per month", "Advanced recruiter reports", "Career Brain", "Improve CV, Cover Letter, and Job Assist"],
    cta: "Upgrade to Premium",
    plan: "premium" as WorkZoPlanType,
  };
}
