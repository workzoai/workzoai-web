...
const NAME_REJECT_PHRASE_RE = /^(core competencies|professional summary|executive summary|career summary|profile summary|work experience|professional experience|key projects|selected projects|academic projects|magna cum laude|cum laude|summa cum laude|customer success|customer success achievements|customersucces sachievements|it support|it support specialist|data tools|invoicing tools|taxation tools|creativity negotiation|leadership critical thinking|englisch fließend|english fluent|english c1|deutsch b1|deutsch b2|deutsch a2|deutsch a1|german b1|german conversational|haritha itsd)$/i;
