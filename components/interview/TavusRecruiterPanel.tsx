...
export default function TavusRecruiterPanel({
  ...
  if (conversationUrl && status === "live") {
    return (
      <div className="absolute inset-0 bg-black">
        ...
        <div className="pointer-events-none absolute left-4 top-4 z-[80] rounded-lg border border-line bg-canvas/72 px-3 py-2 text-xs font-black text-fg backdrop-blur-xl">
        ...
        <button
          ...
          className="absolute right-4 top-4 z-[90] inline-flex items-center gap-2 rounded-lg bg-danger/90 px-4 py-2 text-xs font-black text-on-brand shadow-[0_16px_38px_rgba(244,63,94,.24)] transition hover:bg-danger"
        >
        ...
        {warning && (
          <div className="absolute inset-x-4 bottom-20 z-[90] mx-auto max-w-lg rounded-lg border border-warning/20 bg-warning/14 p-3 text-center text-xs font-bold leading-5 text-warning backdrop-blur-xl">
            {warning}
          </div>
        )}
      </div>
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-brand">
      <div className="pointer-events-auto mx-4 w-full max-w-md rounded-[28px] border border-line bg-fg/[0.06] p-5 text-center shadow-[0_24px_100px_rgba(0,0,0,0.45)] backdrop-blur-2xl">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-lg bg-brand/12 text-brand">
        ...
        <div className="mt-3 rounded-lg border border-line bg-canvas-soft p-3 text-xs leading-5 text-muted">
          <div className="flex items-center justify-center gap-2 font-black text-brand">
        ...
        {message && (
          <div className="mt-4 rounded-lg border border-warning/20 bg-warning/10 p-3 text-xs leading-5 text-warning">
        ...
        <button
          ...
          className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-brand to-brand px-5 py-3 text-sm font-black text-on-brand shadow-[0_0_30px_rgba(37, 99, 235,0.25)] transition hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-50"
        >
          {status === "starting" ? (
            <>
