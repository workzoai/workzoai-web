  ...
  const signalTone =
    recruiterTrust >= 68
      ...
      : recruiterTrust < 45
        ...
        : "text-cyan-100 border-cyan-300/20 bg-cyan-400/10";

  return (
    <section className="relative min-h-[100svh] overflow-x-hidden overflow-y-auto bg-[#020617] px-4 pb-[calc(132px+env(safe-area-inset-bottom))] pt-[calc(14px+env(safe-area-inset-top))] text-white md:px-6 md:pb-[calc(112px+env(safe-area-inset-bottom))] lg:px-8">
      <style>{`
      ...
      <header className="relative z-20 mx-auto flex max-w-[1120px] items-center justify-between gap-3">
        <Link
          href="/dashboard"
          className="inline-flex h-10 items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.055] px-4 text-[13px] font-bold text-slate-200 shadow-[0_10px_35px_rgba(0,0,0,0.22)] backdrop-blur-xl transition hover:bg-white/[0.08]"
        >
          <ArrowLeft className="h-4 w-4" />
          Back
        </Link>

        <div className="flex h-10 shrink-0 items-center rounded-full border border-white/[0.08] bg-white/[0.045] p-1 text-[11px] font-black text-slate-400 shadow-[0_10px_35px_rgba(0,0,0,0.22)] backdrop-blur-xl">
          <button
            type="button"
      ...
      <main className="relative z-10 mx-auto mt-4 grid max-w-[1120px] gap-4 md:mt-5 md:grid-cols-[0.92fr_1.08fr] md:items-start lg:gap-5">
        <section className="flex min-w-0 flex-col items-center md:sticky md:top-5">
          <div
            className="relative h-[236px] w-full max-w-[420px] overflow-hidden rounded-[34px] border border-blue-200/10 bg-white/[0.025] shadow-[0_0_64px_rgba(37,99,235,0.22)] md:h-[420px] md:max-w-none lg:h-[460px]"
          ...
          >
            ...
            <div
              className={cn(
                "pointer-events-none absolute inset-5 z-20 rounded-[30px] bg-cyan-300/10 blur-2xl",
                isSpeaking && "bg-cyan-300/20",
                isListening && "bg-emerald-300/14",
              )}
            ...
            />
            <span className="wz-mobile-blink pointer-events-none absolute left-1/2 top-[32%] z-30 h-[18px] w-[118px] rounded-full bg-slate-950/55 blur-[2px]" style={{ animation: "wzMobileBlink 5.7s ease-in-out infinite" }} />

            <div className="absolute inset-x-0 bottom-0 z-30 bg-gradient-to-t from-[#020617]/88 via-[#020617]/45 to-transparent p-4 md:p-5">
          ...
          <div className="mt-4 flex items-center gap-2 text-center text-[14px] font-semibold text-slate-300 md:mt-4">
        ...
        <section className="min-w-0 space-y-4">
          <div className="rounded-[26px] border border-white/[0.07] bg-[#07111f]/90 p-4 shadow-[0_18px_60px_rgba(0,0,0,0.26)] backdrop-blur-xl md:p-5 lg:p-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-[11px] font-black uppercase tracking-[0.22em] text-cyan-300/85">
                  Current Question
                </p>
                <h1 className="mt-3 text-[24px] font-black leading-[1.08] tracking-[-0.03em] text-white md:text-[30px] lg:text-[34px]">
                  {question}
                </h1>
              </div>
          ...
          {shortCaption ? (
            <div className="rounded-[24px] border border-white/[0.055] bg-white/[0.035] p-4 text-[13px] font-medium leading-6 text-slate-300 shadow-[0_14px_45px_rgba(0,0,0,0.22)] backdrop-blur-xl md:p-5 md:text-[14px]">
              <p className="mb-2 text-[10px] font-black uppercase tracking-[0.22em] text-slate-500">Live recruiter caption</p>
              {shortCaption}
            </div>
          ) : null}
      ...
      <footer className="fixed inset-x-0 bottom-0 z-40 border-t border-white/[0.06] bg-[#020617]/90 px-4 pb-[calc(12px+env(safe-area-inset-bottom))] pt-3 shadow-[0_-20px_70px_rgba(0,0,0,0.35)] backdrop-blur-2xl md:px-6 md:pb-[calc(12px+env(safe-area-inset-bottom))]">
        <div className="mx-auto flex max-w-[520px] items-center justify-between gap-3 md:max-w-[760px]">
          <button
            type="button"
            onClick={onToggleSpeaker}
            className="grid h-12 w-12 place-items-center rounded-full border border-white/[0.08] bg-white/[0.05] text-slate-200 transition active:scale-95 md:h-11 md:w-11"
          ...
          <button
            ...
            onClick={onMicClick}
            className={cn(
              "grid h-[78px] w-[78px] place-items-center rounded-full border text-white shadow-[0_0_50px_rgba(59,130,246,0.34)] transition active:scale-95 md:h-[70px] md:w-[70px]",
              isLive
          ...
          >
            <span className="grid h-[62px] w-[62px] place-items-center rounded-full bg-gradient-to-br from-blue-500 to-violet-600 shadow-[inset_0_1px_0_rgba(255,255,255,0.25)] md:h-[54px] md:w-[54px]">
          ...
          <button
            ...
            className="grid h-12 w-12 place-items-center rounded-full border border-red-300/15 bg-red-500/10 text-red-200 transition active:scale-95 md:h-11 md:w-11"
