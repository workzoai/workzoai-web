...
function CollapsibleSection({
  ...
  return (
    <div className="rounded-xl border border-line bg-fg/[0.03]">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
      ...
      <main className="min-h-screen bg-canvas px-4 py-6 text-fg sm:px-5">
        ...
        <header className="mx-auto mb-6 flex max-w-6xl items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-muted">WorkZo AI</p>
            </div>
          </div>
        </header>
        ...
        <section className="mx-auto max-w-6xl rounded-lg border border-line bg-fg/[0.035] p-5 shadow-2xl shadow-black/20 sm:p-6">
          <div className="flex items-start gap-3">
            <div className="grid h-11 w-11 shrink-0 place-items-center rounded-lg bg-brand/20 text-brand">
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="block">
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border border-line bg-canvas-soft px-4 py-3 text-sm outline-none transition focus:border-brand"
        ...
        {/* ── Step 2: your result ───────────────────────────────────────── */}
        <section className="mx-auto mt-6 max-w-6xl rounded-lg border border-line bg-fg/[0.03] p-5 shadow-2xl shadow-black/20 sm:p-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="inline-flex rounded-lg border border-line bg-canvas-soft p-1">
              <button
                type="button"
