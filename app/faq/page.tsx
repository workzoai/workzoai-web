...
const faqs = [
  ...
  { q: "What does Premium unlock?", cat: "plans", a: "Premium gives you 300 voice minutes a month with unlimited sessions, full advanced reports, Improve CV with ATS keyword analysis, Cover Letter generation, Job Assist with fit scores and likely questions, Career Brain memory, and multi-session trend tracking." },
  { q: "What is Premium Pro?", cat: "plans", a: "Premium Pro is the complete interview mastery system. It includes 600 AI voice minutes a month, 60 AI video minutes, premium personas, AI Career Coach, interactive 30/60/90 day career roadmaps, Replay Intelligence, and priority AI models." },
