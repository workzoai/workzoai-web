    ...
    <main className="min-h-screen bg-[#04080f] text-white">
      ...
      <div className="mx-auto max-w-4xl px-5 py-12 sm:px-6 lg:px-8">
        ...
        <header className="mt-10">
          ...
          <h1 className="mt-5 text-4xl font-black tracking-[-0.04em] sm:text-5xl">Frequently asked questions</h1>
        ...
        <div className="mt-6 rounded-[2rem] border border-white/10 bg-white/[0.03] px-6">
          {visible.map((f) => <FaqItem key={f.q} {...f} />)}
        </div>

        <div className="mt-10 rounded-[2rem] border border-blue-300/20 bg-blue-500/[0.07] p-7">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <a href="mailto:support@workzoai.com" className="inline-flex items-center gap-2 rounded-2xl bg-blue-500 px-5 py-3 text-sm font-black text-white hover:bg-blue-400">
              support@workzoai.com <ArrowRight className="h-4 w-4" />
            </a>
            <Link href="/help" className="inline-flex items-center gap-2 rounded-2xl border border-white/10 bg-white/[0.04] px-5 py-3 text-sm font-black text-slate-200 hover:bg-white/10">
              Help center
            </Link>
          </div>
        </div>
