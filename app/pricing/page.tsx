...
const PRICING_CARDS: PricingCard[] = [
  {
    ...
    features: [
      ...
      "LinkedIn vs CV consistency check",
      "Free CV Review",
  ...
  },
  {
    ...
    features: [
      ...
      "AI LinkedIn rewrite (headline + About)",
...
const comparisonRows = [
  ...
  { label: "LinkedIn vs CV Consistency", free: "Included", premium: "Included", pro: "Included", enterprise: "Included" },
  { label: "LinkedIn vs Job Match", free: "Included", premium: "Included", pro: "Included", enterprise: "Included" },
  { label: "AI LinkedIn Rewrite", free: " - ", premium: "Unlimited", pro: "Unlimited", enterprise: "Unlimited" },
