  ...
  return (
    <main className="min-h-screen bg-[#04080f] px-5 text-white">
      ...
      <div className="mx-auto flex min-h-screen max-w-lg flex-col items-center justify-center py-16">
        <div className="grid h-16 w-16 place-items-center rounded-xl bg-slate-400/15 text-slate-200">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <Link href="/pricing" className="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-500 px-6 py-4 text-sm font-black text-white hover:bg-blue-400">
            View plans again <ArrowRight className="h-4 w-4" />
          </Link>
          <Link href="/onboarding" className="inline-flex items-center justify-center gap-2 rounded-lg border border-white/10 bg-white/[0.04] px-6 py-4 text-sm font-black text-slate-200 hover:bg-white/[0.08]">
