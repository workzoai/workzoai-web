      ...
      <div className="mx-auto max-w-4xl px-5 py-10 sm:px-6">
        ...
        <div className="mt-10 flex items-start gap-5">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-6 text-muted">Last updated: June 2026 · WorkZo AI, Würzburg, Germany · support@workzoai.com</p>
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link href="/legal/cookies" className="rounded-xl border border-line bg-fg/[0.03] px-4 py-2 text-sm text-muted hover:text-fg">Cookie Policy</Link>
