    ...
    <main className="min-h-screen bg-[#050a12] text-white">
      <div className="mx-auto max-w-4xl px-5 py-10 sm:px-6">
        ...
        <div className="mt-10 flex items-start gap-5">
          <div className="grid h-14 w-14 shrink-0 place-items-center rounded-2xl bg-blue-400/10">
          ...
          <div>
            ...
            <h1 className="mt-2 text-4xl font-black tracking-[-0.04em] sm:text-5xl">Privacy Policy</h1>
