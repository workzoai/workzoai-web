  ...
  return (
    <main className="min-h-screen bg-[#04080f] text-white">
      ...
      <div className="mx-auto max-w-5xl px-5 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 rounded-lg border border-blue-300/20 bg-blue-500/[0.07] p-7">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <a href="mailto:support@workzoai.com?subject=WorkZo AI Feature Request" className="inline-flex items-center gap-2 rounded-lg bg-blue-500 px-5 py-3 text-sm font-black text-white hover:bg-blue-400">
              Send a suggestion <ArrowRight className="h-4 w-4" />
            </a>
            <Link href="/pricing" className="inline-flex items-center gap-2 rounded-lg border border-white/10 bg-white/[0.04] px-5 py-3 text-sm font-black text-slate-200 hover:bg-white/10">
              View pricing
            </Link>
          </div>
        </div>
